...
const customersPurchases = {
  ...
  5494378: {
    ...
    age: "65",
    phone: "04263223955",
    email: "mayorarondon56@gmail.com",
    gender: "f",
    list1: {
      name: "Peinadora",
      price: "14000",
...
class SearchCustomers {
  ...
  searchRestart() {
    this.customers.container.children[0].style = defaultStatus;
...
// EVENTOS
customers.btn.addEventListener("click", (e) =>
  new SearchCustomers(customers, customersPurchases).search()
);
